            ...
            let annotator_state: &SharedAnnotatorState = window
                ...
                .get_global_or_insert_with(|| {
                    ...
                    let annotator_state = AnnotatorState {
                        ...
                        marker_pen_straight_mode: crate::config::AnnotatorConfig::load()
                                ...
                                } = event
                                {
                                    ...
                                    if *key == egui::Key::C && is_ctrl {
                                        ...
                                        window
                                            .window_context
                                            .commands
                                            .push_back(Command::CopyImage(image_receiver));
                                        if crate::config::AnnotatorConfig::load().exit_after_copy {
                                            window
                                                .window_context
                                                .commands
                                                .push_back(Command::CloseWindow);
                                    ...
                                    if *key == egui::Key::S && is_ctrl {
                                        let image_receiver = annotator_state
                                            ...
                                            .take_screenshot(ui.pixels_per_point());
                                        let exit_after_save =
                                            crate::config::AnnotatorConfig::load().exit_after_save;
                                        window.window_context.commands.push_back(
                                            Command::SaveImage(image_receiver, exit_after_save),
                                        );
                                    }
                                }
                            }
    ...
    Area::new("toolbar-toggle".into())
        ...
        .show(ui, |ui| {
            ...
            ui.painter().rect_filled(
                ...
                6.0,
                if response.hovered() {
                    crate::toolbar_style::HOVER
                } else {
                    crate::toolbar_style::BACKGROUND
                },
            );
