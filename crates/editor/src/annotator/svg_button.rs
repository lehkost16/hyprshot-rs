...
impl Widget for SvgButton {
    fn ui(self, ui: &mut Ui) -> Response {
        ...
        let bg_color_hover = crate::ui::toolbar_style::HOVER;
        let bg_color_active = crate::ui::toolbar_style::SURFACE;
        let bg_color_checked = crate::ui::toolbar_style::ACCENT;
        ...
        if !self.disabled {
            ...
            if let Some(instant_clicked) = instant_clicked {
                ...
                ui.painter().rect(
                    ...
                    corner_radius,
                    bg_color_hover,
                    Stroke::new(1_f32, crate::ui::toolbar_style::BORDER),
                    StrokeKind::Inside,
                );
            }
