                ...
                Box::new(move |input, egui_ctx, app, window, current_view| {
                    ...
                    egui_ctx.run_ui(input, |ctx| {
                        ...
                        egui::CentralPanel::default()
                            .frame(crate::toolbar_style::frame(true))
                            .show(ctx, |ui| {
...
impl Widget for StrokeTypeButton {
    fn ui(self, ui: &mut Ui) -> Response {
        ...
        if self.selected {
            ui.painter()
                .rect_filled(rect, 4.0, crate::toolbar_style::ACCENT);
        } else if response.hovered() {
            ui.painter()
                .rect_filled(rect, 4.0, crate::toolbar_style::HOVER);
        } else {
            ui.painter()
                .rect_filled(rect, 3., crate::toolbar_style::SURFACE);
        }
