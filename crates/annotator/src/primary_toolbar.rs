        ...
        Box::new(|input, egui_ctx, _app, window, current_view| {
            egui_ctx.run_ui(input, |ctx| {
                egui::CentralPanel::default()
                    ...
                    .show(ctx, |ui| {
                        crate::toolbar_style::configure(ui);
                        ui.ctx().set_cursor_icon(egui::CursorIcon::Default);
                        crate::toolbar_style::frame(false).show(ui, |ui| {
...
pub(crate) fn primary_controls(
        ...
        .clicked()
    {
        ...
        let exit_after_save = crate::config::AnnotatorConfig::load().exit_after_save;
        window
            .window_context
            .commands
            .push_back(Command::SaveImage(image_receiver, exit_after_save));
    }
