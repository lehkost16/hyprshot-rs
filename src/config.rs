...
impl Config {
    ...
    fn add_comments(toml: &str) -> String {
        let header = "# Hyshot configuration file\n\
                      # This file is automatically generated. You can also edit it manually.\n\
                      # Documentation: https://github.com/shikoucore/hyshot\n\n";
        ...
        for line in toml.lines() {
            ...
            } else if line.starts_with("[external.") {
                result.push_str(
                    "\n# External tool command. {path} is replaced with a temporary PNG.\n",
                );
